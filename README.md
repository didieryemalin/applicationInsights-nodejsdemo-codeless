# Lab for NodeJS App service extension
...
* .azure ---------------- Environment variables used to deploy resources to Azure
* .github --------------- GitHub pipeline configuration
* infra  ---------------- Bicep files of the needed Azure resources
* src     
    ├── app  ------------ NodeJS Todo App    
    └── task-processor -- Task Processor Azure Function
...
```bash
mkdir globallabnjext
cd globallabnjext
azd up --template https://github.com/didieryemalin/applicationInsights-nodejsdemo-codeless
```
